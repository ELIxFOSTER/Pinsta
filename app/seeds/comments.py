...
def seed_comments():
    c1 = Comment(comment="I love this game", pin_id=3, user_id=1)
    c2 = Comment(comment="Nice pin!!!", pin_id=7, user_id=1)

    c3 = Comment(comment="I love Waffles", pin_id=1, user_id=2)
    c4 = Comment(comment="This song is old!", pin_id=9, user_id=2)

    c5 = Comment(comment="This is really cool", pin_id=8, user_id=3)
